...
namespace TerminZaVozacka.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult AddToRole()
        {
            ...
            model.Roles = new List<string>() { "Administrator", "User", "Employee" };
            return View(model);
        }
        ...
        public ActionResult AddToRole(AddToRoleModel model)
        {
            ...
            {
                UserManager.AddToRole(applicationUser.Id, model.SelectedItem);
            }
            return RedirectToAction("Index", "Prijavas");
        }
